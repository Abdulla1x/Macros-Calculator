...
> **Pick a non-EEA region.** Gemini's *free* tier is unavailable in the EEA, UK and
> Switzerland, so a backend in Render's Frankfurt region fails every analysis with
